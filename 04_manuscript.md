...
|---|---|---|---|---|
| CMU SEI × Accenture | 100건 이상 검토, 36개 이상 정밀 분석, 임원 20명 이상 인터뷰, 실무자 약 600명 설문, Fortune 500 파일럿 | 5단계·8차원·27역량영역, 124쪽 원문 공개 | 공학적 실천과 증거 구조가 가장 촘촘하다 | 검증은 2단계이며 자원·비용의 독립 역량영역과 담당자 인계 문항은 없다 |
