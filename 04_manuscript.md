...
하나만 먼저 밝혀두는 편이 낫겠다. 이 책에 실린 자는 성숙도 모델을 만들자고 시작한 물건이 아니다. **구성원들이 AX 과제를 하다가 어디서 막히는지, 그래서 조직이 무엇을 더 깔아줘야 하는지를 찾으려고 여정 전체를 빠짐없이 훑어본 것**이 먼저였다. 단계와 등급은 그 항목들을 정리하다 보니 나온 형태다. 그러니 낮은 단계가 나와도 그건 구성원이 부족하다는 뜻이 아니다. 그 이야기는 에필로그에 조금 더 적어두었다.
...
짧은 배경 하나만 덧붙이자. 이 자는 책상에서 나오지 않았다. 개발 프로세스의 성숙도를 재던 10년과 AX를 직접 굴려본 최근의 시간이 겹치는 자리에서 나왔다. 두 시간이 겹치지 않았다면 아마 지금과 다른 모양이었을 것이다. 문항 하나하나를 같이 의심해준 동료들에게 빚이 있다.
...
게임을 알아본 것이 **자산**이 되는 경우가 있다. 이 게임이 어떻게 굴러가는지뿐 아니라 *어떻게 망하는지*까지 알기 때문에, 이번엔 다르게 짜는 경우다. **함정**이 되는 경우도 있다. 아는 게 반가운 나머지 옛날 판을 그대로 들고 와서, 옛날처럼 망하는 경우다. 익숙한 틀은 손에 잘 잡히기 때문에, 함정 쪽이 훨씬 편하고 빠르다. 이 책은 그럼에도 전자를 택하려고 애쓴 기록이다.

그러니 자격 증명부터 하는 대신 실패담부터 꺼내는 편이 낫겠다. 성숙도 모델 자체가 나빴던 게 아니다. **재는 행위에 등급이 붙는 순간 게임이 시작됐다.** 그 게임이 조직을 망가뜨리는 방식은 다섯 가지였다.

먼저 등급이 목적이 된다. 개선하려고 재는 게 아니라 등급을 따려고 재기 시작한다. 그러면 문서가 두 벌이 된다. 실제로 일할 때 쓰는 문서와 심사에 보여줄 문서가 갈라지고, 후자를 만드는 데 몇 달이 들어간다. 그렇게 등급을 따고 나면 어떻게 될까? 심사가 끝난 다음 달이면 조직은 대체로 원래대로 돌아가 있다.
...
따고 나면 원복하는 문제에는 최고 단계의 정의로 답했다. 마지막 단계는 '도달'이 아니라 **되돌아옴**이다. 정상에 서 있는 상태가 아니라, 미끄러졌을 때 되돌아오는 능력을 잰다. 이 차이는 기억해두자.
...
여기서 한 가지 의문이 생긴다. 심사를 없앤 건 그저 편하자고 한 일 아닐까? 아니다. 한 문장으로 정리해두자. **심사를 없앤 건 편의가 아니라 설계다.**
...
나는 그 표정 쪽이 옳다고 본다. 그리고 그 반감은 회의실의 푸념만이 아니다. 학술 문헌도 오래전부터 같은 말을 해왔고, 그 지적들은 대체로 정확하다.[^c3n2]
...
**하나.** 성숙도 모델에 대한 반감은 근거가 있다. 학계가 오래 지적해온 문제가 넷이다. 현실을 계단으로 단순화한다는 것, 순서에 근거가 없다는 것, 등급이 목적이 된다는 것, 진단만 하고 처방이 없다는 것. 조직 안에서 반대하는 사람이 있다면 대체로 그 사람이 겪어봐서 그런 것이다.

**둘.** 그래서 결과를 볼 때 조직 단계 숫자 하나만 보지 않는 편이 낫다. 축별로 어디가 낮은지, 그리고 그 불균형이 얼마나 큰지가 실제 정보다. 숫자 하나는 보고용이고 불균형은 처방용이다.

**셋.** 진단 결과를 평가에 연결하지 않는 것이 이 도구를 살리는 최소 조건이다. 평가에 붙는 순간 응답은 협상이 되고, 그때부터 우리가 보는 건 조직의 상태가 아니라 조직의 방어다. 점검표를 돌리기 전에 "이건 평가에 안 들어갑니다"라고 말해두는 자리가 있는데, 그 한마디를 하고도 회의실 표정이 안 풀리면 이미 늦은 것이다. 그럴 때는 그냥 이번 분기를 건너뛰는 편이 낫다.

**넷.** 학술 문헌이 지적한 최대 빈틈은 논문으로 제안된 AI 성숙도 모델을 실제 조직에 적용해본 연구가 한 건도 없었다는 것이다. 물론 예외는 있다. 앞 장에서 본 대로 실무 파일럿까지 마치고 나온 모델도 있다. 다만 그런 자가 흔하지 않다는 것이 문제였고, 그래서 이 모델은 사이트로 응답을 받아본 다음에 책이 나온다. 도구를 고를 때 던져볼 만한 질문이 여기서 하나 나온다. **"이 모델은 실제로 몇 개 조직에 적용됐습니까?"** 답이 돌아오지 않는 자는 아직 자가 아니라 가설이다.
...
이제 자를 실제로 만들어볼 차례다. 자를 만들려면 눈금을 그리기 전에 무엇을 재는지부터 정해야 한다. 기존 모델들은 그 축을 경영의 언어로 나눴다. 전략, 데이터, 거버넌스, 인재. 위에 보고하기에는 좋은 이름들이다. 그런데 그 칸에 우리 팀이 지난 반년 겪은 일을 하나씩 넣어보려 하면 어디에도 들어맞지 않는다. 그렇다면 무엇을 기준으로 나눠야 할까. 다음 장에서 왜 여섯 개의 축이고, 왜 하필 그 여섯인지를 함께 짚어보자.
...
한 가지만 더 당부하고 싶다. 이 규칙들은 우리를 심사하려고 있는 게 아니다. 우리가 우리에게 후하게 주고 싶어지는 순간을 대비해 미리 걸어둔 안전장치다. 그러니 결과가 예상보다 낮게 나왔다고 규칙을 손보고 싶어진다면, 그 마음이 든 것 자체를 기억해두자. 그 마음이 10년 전에 등급을 만들었다.
...
그런데 이상한 일이 하나 있다. **이걸 묻는 모델을 나는 아직 못 봤다.** SEI 원문 124쪽 전체를 뒤져도 인계나 승계, 소유권 이전에 해당하는 표현이 한 번도 나오지 않는다. 같은 모델이 AI 모델의 생애주기는 폐기 단계까지 관리하라고 말하는데도 그렇다.[^c10n2] 물건이 언제 죽는지는 묻고, 사람이 바뀔 때 그 물건이 어떻게 되는지는 묻지 않는다.
...
**넷.** 그리고 이 축의 마지막 문항은 우리가 뒤져본 어느 모델에서도 못 찾은 것이다. **담당자가 바뀌면 그 물건은 어떻게 되는가.** 자랑이 아니라 표본의 문제다. 인사 절차가 촘촘한 조직에게는 물을 이유가 없는 질문이었을 뿐이다. 이번 분기에 딱 하나만 한다면 이걸 하자. 가장 많이 쓰는 것 하나를 골라, 내일 담당자가 사라져도 이어받을 수 있게 한 장을 적어두는 것.
...
앞의 네 축은 우리 손이 닿는 자리였다. 교육 경로를 손보고, 할 일의 정의를 문서로 만들고, 회귀 점검 하나를 붙이는 일은 다음 분기에 우리가 시작할 수 있다. 반면 자원과 보안은 다르다. 결재선을 타고 올라가야 하고, 우리가 아무리 급해도 우리 속도로는 움직이지 않는다. 4장에서 이 두 축을 왜 굳이 자에 남겼는지는 이미 이야기했다. 여기서 할 이야기는 그다음이다. **그래서 그 결과를 어떻게 쓰느냐.**
...
이런 상황을 떠올려보자. 위에서 진척을 물을 때마다 입이 안 떨어진다. 딱히 논 것도 아닌데 보여줄 게 없어서, 지난 분기와 같은 말을 조금 다르게 바꿔서 하게 된다. 그러다 보면 스스로도 자기가 부족해서라고 믿게 된다. 그런데 실제로 재봤더니 A부터 D까지는 3단계인데 I축이 1단계였다면, 그때부터 이야기가 완전히 달라진다. 우리는 갈 수 있는 데까지 간 것이고, 남은 건 우리 손에 없다.
...
자원 축의 아래 두 칸은 요즘 웬만한 조직이 채운다. 구성원에게 쓸 것이 어떤 형태로든 주어지고(I1), 한도가 얼마이고 어디에 신청하는지가 안내돼 있다(I2). 여기까지는 대개 '보유'가 찍힌다.

문제는 그다음 칸이다. **시범이 아니라 실 운영에 필요한 자원을 어디서 어떻게 확보하는가**(I3). 여기서 끊기는 조직이 많다.

둘의 성격이 다르기 때문이다. 시범 자원은 한 번 쓰고 끝나고, 얼마가 들지 미리 알 수 있고, 어차피 실험이니 누가 융통해줄 수도 있다. 실 운영 자원은 매달 나가고, 쓰는 사람이 늘면 같이 늘고, 끝이 없다. 앞엣것은 인심으로 해결되지만 뒤엣것은 예산 구조가 받아줘야 한다. 그런데 조직은 대개 앞엣것만 준비해두고 뒤엣것은 준비해두지 않는다.

그래서 **만들었는데 못 켜는** 상황이 생긴다. 이 자리가 특히 아까운 이유가 있다. 여기서 멈추면 이미 쓸 돈은 다 쓴 다음이라는 것이다. 사람이 반년을 붙었고, 배웠고, 만들었다. 그 비용은 되돌릴 수 없는데 결과물은 켜지지 않는다. 아무것도 시작하지 않은 것보다 나쁜 자리다.
...
그리고 여기에 눈에 잘 안 띄는 손해가 하나 더 붙는다. 요청이 기록되지 않으면 **조직은 자기가 무엇에 막혀 있는지 모른다.** 거절당한 기록조차 남지 않으니, 위에서는 아무도 필요로 하지 않는다고 읽는다. 아래에서는 요청해봐야 소용없다고 읽는다. 양쪽 다 틀린 채로 한 해가 간다.

맨 위 칸(I5)이 이 축의 결론이다. AI 사용료와 토큰과 컴퓨팅이 **정식 예산 항목**으로 배분되고, 그 배분을 주관하는 거버넌스가 있는가.

말장난처럼 들릴 수 있으니 구분을 분명히 하자. 취합은 각 조직이 적어 올린 숫자를 모아 합계를 내고, 총액이 넘치면 일괄로 깎는 일이다. 배분은 어디에 얼마가 필요한지 판단해서 나눠주는 일이다. 많은 조직에 앞엣것을 하는 기능은 있는데 뒤엣것을 하는 기능이 없다. 그러면 AI 사용료는 매년 가장 먼저 깎이는 항목이 된다. 새로 생긴 데다 효과를 숫자로 대기 어려운 항목이니까.

관점을 이렇게 옮겨보면 어떨까. 업무회의비나 도서구입비를 생각해보자. 아무도 "그 책 읽어서 얼마 벌었냐"고 묻지 않는다. 일하는 데 필요한 기본 비용으로 합의돼 있기 때문이다. **AI 사용료도 그 자리로 가야 한다.** 성과를 증명해야 받는 특별 예산으로 남아 있는 한, 그 성과를 재기 위해 필요한 자원부터 없는 상태가 계속된다.

한 가지 덧붙이자면, 자원과 비용을 독립된 축으로 세운 성숙도 모델은 사실상 없다. 카네기멜런 SEI 모델 124쪽에도 이에 대응하는 역량영역이 없고 예산은 부속 언급으로 한 번 나올 뿐이다.[^c12n1] 자랑할 일이 아니라 표본의 문제다. **재는 대상이 다르면 보이는 벽도 다르다.** 그들이 상정한 조직에게 이건 문제가 아니었고, 우리에게는 가장 먼저 만나는 벽이다.
...
여기서 기준을 만드는 방향이 갈린다. 손쉬운 길은 금지 목록을 늘리는 것이다. 그런데 금지가 길어지면 사람들은 둘 중 하나를 한다. 안 하거나, 몰래 하거나. 둘 다 조직에 손해다.
...
이게 여유 있는 조직의 사치가 아니라는 근거는 1장에서 이미 봤다. 최상위 조직과 나머지 전체를 가른 항목 중 격차가 가장 컸던 것이 바로 이것이었다. 에이전트의 행동을 가드레일과 실시간 모니터링으로 통제할 수 있다고 답한 비율이 **84퍼센트 대 24퍼센트**였다.[^c12n2] 통제할 수 있는 조직이 더 많이 굴린다. 순서가 그 반대가 아니다.
...
J5는 개발·운영 단계별 보안 점검이 **출시 절차 안에 들어가 있는가**를 묻는다. 사람이 기억해서 챙기는 점검은 한가한 분기에는 잘 돌아가고 바쁜 분기에 가장 먼저 빠진다. 그런데 사고는 바쁜 분기에 난다.
...
그래서 이 두 축은 한 자리에 놓고 봐야 한다. 하나씩 따로 재면 각각은 그럭저럭 넘어가는 것처럼 보이는데, 실제로 앞을 막는 건 둘이 겹치는 자리다. 게다가 두 벽이 향하는 곳은 대개 같은 결재선이다. 한쪽만 뚫고 올라갔다가 다른 쪽에서 다시 멈춰 서면, 그때는 두 번째 상신을 처음부터 준비할 기운이 잘 안 난다. 첫 번째로 이미 쓸 만한 설득을 다 써버렸기 때문이다. 두 축의 결과를 나란히 들고 올라가야 하는 이유가 여기 있다.

## 그래서 무엇을 할까 — 축마다 한 걸음

열 문항을 봤으니 처방도 열 개를 늘어놓고 싶어진다. 그러지 말자. 어차피 우리가 직접 하는 일이 아니고, 위로 올릴 수 있는 건 한 번에 하나 정도다. 축마다 하나씩만 짚어두자. 둘 다 들고 올라가라는 뜻은 아니다. 두 축이 다 낮게 나왔을 때 무엇을 먼저 꺼낼지 고를 수 있게 두 개를 나란히 놓아두는 것이고, 실제로 들고 가는 건 **그중 하나**다.

**자원 쪽은, 요청 말고 견적을 올리는 것부터다.** 이미 돌고 있는 것 하나를 골라 한 달 실사용량을 잰다. 그리고 전 부서로 넓히면 얼마인지, 지금 켜지 못하면 여기까지 들인 것이 어떻게 되는지를 한 장으로 만든다. "자원이 부족합니다"라는 문장은 결재가 나지 않는다. 취합의 대상이 될 뿐이다. 반면 숫자가 붙은 종이 한 장은 판단의 대상이 된다.
...
빈손으로 올라가서 기준을 만들어달라고 말을 꺼내는 건 어쩐지 겸연쩍고, 상대도 무엇부터 봐야 할지 모른다. 그런데 종이 한 장이 있으면 대화가 검토에서 시작한다. 됐다는 신호는 다음 과제가 같은 협의를 처음부터 다시 하지 않는 것이다. 흔한 실패는 그 한 장이 어느새 금지 목록으로 자라는 것이다. 그러면 레일을 깔려다 벽을 하나 더 세운 셈이 된다.

::: {.leader-summary}

## 다음 보고에서 쓸 것

**하나.** 진단 결과는 두 칸으로 갈라 읽어야 한다. A부터 D까지는 우리가 다음 분기에 손댈 수 있는 자리고, I와 J는 결재선을 타야 움직이는 자리다. 섞어 읽으면 처방이 전부 "더 열심히"로 수렴한다.

**둘.** 병목이 뒤 칸에 있다는 사실 자체가 결과다. 팀이 부족해서 멈춘 게 아니라 갈 수 있는 데까지 간 것이다. 이 구분은 팀을 자책에서 꺼내는 동시에, 리더가 무엇을 위로 들고 가야 하는지를 알려준다.

**셋.** 자원 축에서 가장 자주 끊기는 자리는 시범과 실 운영 사이다. 시범 자원은 인심으로 나오지만 실 운영 자원은 예산 구조가 받아줘야 한다. 여기서 멈추면 쓸 비용은 다 쓴 뒤에 결과물만 못 켜는 상태가 된다.

**넷.** AI 사용료는 성과를 증명해야 받는 특별 예산이 아니라 도서비나 회의비 같은 정식 항목으로 가는 편이 낫다. 그리고 예산 기능이 취합과 삭감만 하고 배분을 주관하지 않으면, 그 항목은 매년 가장 먼저 깎인다.

**다섯.** 기존 보안 기준은 "누가 무엇에 접근하는가"를 통제하도록 만들어졌다. 에이전트는 접근하는 게 아니라 행동한다. 행동의 범위를 정하는 별도 기준이 필요하고, 그 방향은 금지 목록을 늘리는 쪽이 아니라 권장 경로를 넓히는 쪽이다. 최상위 조직과 나머지를 가른 격차가 가장 컸던 항목이 정확히 이 통제 능력이었다.

:::

## 마무리

기억해두자. 이 두 축에서 낮은 단계가 나왔다고 해서 그게 우리 팀의 성적표는 아니다. 그런데 반대로, 낮게 나왔으니 우리는 할 게 없다는 뜻도 아니다. **위로 올릴 것이 무엇인지 정확히 알게 됐다는 게 이 두 축의 결과물이다.** 막연히 "지원이 부족합니다"라고 적어 올릴 때는 쓰는 쪽도 어쩐지 눈치가 보인다. 근거 없이 손을 벌리는 것처럼 읽히기 때문이다. 그 자리에 이제 문항 번호와 다음 한 걸음이 붙는다. 그 차이가 생각보다 크다.
...
다음 장에서 그 이야기를 하자. 자를 대는 일은 여기서 끝나고, 고르는 일이 시작된다.
...
[^c12n2]: Cisco AI Readiness Index 2025. 최상위 그룹과 전체 응답의 항목별 격차 중 하나로, 에이전트 행동을 가드레일·실시간 모니터링으로 통제할 수 있다는 응답이 84퍼센트 대 24퍼센트였다. 1장에서 인용한 것과 같은 출처다. — https://www.cisco.com/c/dam/m/en_us/solutions/ai/readiness-index/2025-m10/documents/cisco-ai-readiness-index-2025-realizing-the-value-of-ai.pdf
...
앞서 본 조사의 61퍼센트를 여기서 한 번만 다르게 읽어보자. 공식 AI 전략은 있지만 그것이 완전히 실행되지는 않은 조직이 그만큼이었다는 그 숫자다.[^c14n1] 지금까지는 이걸 있음과 돌아감 사이의 간격으로 읽었는데, 답한 방식을 놓고 다시 보면 다른 게 보인다. **그 61퍼센트도 결국 누군가 한 사람이 자기 조직에 대해 적어낸 답이다.** 문서로는 있고 현장에서는 덜 돈다는 걸 알아챈 사람이 답했으니 그 숫자가 나온 것이고, 위에서 보이는 그림만 갖고 답했다면 그 조직은 나머지 39퍼센트 쪽에 들어갔을 것이다. 밖에서 온 큰 숫자도 뜯어보면 우리가 지금 하려는 그 일, 누가 답했느냐의 문제다.
...
반대 방향으로 갈린 답도 그냥 넘기지 말자. 실무자는 보유라고 했는데 리더가 처음 듣는 항목, 7장에서 조직이 자기가 가진 것을 자기가 모르는 신호라고 했던 그 반대 방향이다. 회의 탁자 위에서는 이게 좀 묘한 장면으로 나타난다. 만든 사람이 별일 아니라는 듯 설명하고, 리더가 그걸 처음 듣는다. 이 자리에서 리더가 좀 겸연쩍어지는 건 자연스럽다. 그런데 그 잠깐의 민망함보다 훨씬 중요한 게 있다. 그 자산은 만든 사람이 부서를 옮기면 그날로 사라진다.
...
**네 번째는 결론 없이 끝내는 것이다.** 90분 동안 이야기는 잘 오갔는데 정해진 게 하나도 없이 헤어지는 자리가 있다. 나오면서 다들 "좋은 이야기 많이 나왔네요"라고 말하지만 그 좋은 이야기는 사흘이면 흩어진다. 그런 회의를 하고 자리로 돌아오는 길은 좀 착잡하다. 이럴 거면 왜 세 사람 90분을 썼나 싶어서다. 다음 한 걸음 하나와 됐다는 신호 한 문장, 그리고 다시 잴 날짜. 이 셋 없이는 자리를 파하지 말자.
...
**넷.** 90분이면 충분하다. 각자 혼자 15분, 갈린 문항 검토 30분, 가장 약한 고리 확인 20분, 다음 한 걸음과 됐다는 신호 15분, 다시 잴 날짜 10분. 이 자리에서 리더가 지킬 규칙은 둘이다. **누가 어느 쪽을 찍었는지는 펼치지 않는다. 그리고 가장 나중에 말한다.** 이름표가 붙는 순간 사람들은 답을 방어하기 시작하고, 가장 높은 사람이 먼저 말하면 나머지 문항은 볼 것도 없어진다.
...
여기까지 오면 우리 손에는 결과지 한 장과 안건 몇 개와 다음 한 걸음 하나가 남는다. 그런데 이 자를 손에 들고 나면 거의 반드시 찾아오는 유혹이 하나 있다. 이 숫자를 어디에 써먹고 싶어지는 마음이다. 옆 조직과 비교하고 싶고, 위에 보여주고 싶고, 잘 나온 축을 앞세우고 싶어진다. 그 마음이 든 순간 이 자는 자에서 성적표로 바뀐다. 마지막 장에서는 그 이야기를 하자. 10년 전에 정확히 그 자리에서 무너진 것을 나는 봤고, 이 모델도 같은 자리에서 무너질 수 있다.

---

[^c14n1]: 8장에서 인용한 것과 같은 조사다. 조사 주체와 표본, 자체 조사라는 단서는 8장 각주에 적어뒀다. — https://www.sei.cmu.edu/library/ai-adoption-maturity-model/
...
등급이 목적이 되는 건 누가 나쁜 마음을 먹어서가 아니다. **비교 가능한 숫자가 사람들 앞에 놓였기 때문이다.** 비교되는 숫자는 예외 없이 관리된다. 10년 전 판에서 배운 게 있다면 그거 하나다.
...
지극히 합리적인 판단이고, 바로 그래서 위험하다. **그 한 장이 두 벌 문서의 첫 장이다.** 처음엔 한 장으로 시작한다. 다음 진단 때 세 장이 되고, 그 문서들은 진단할 때만 열린다. 일할 때 보는 문서는 여전히 따로 있다. 10년 전에는 이걸 몇 달에 걸쳐 몇백 장 규모로 했을 뿐, 시작은 늘 이렇게 착한 한 장이었다.
...
그 요구에 응하는 순간 무슨 일이 벌어지는지는 이제 우리가 안다. 인증에는 심사가 붙고, 심사에는 비용이 붙고, 비용이 붙으면 수익이 생긴다. 그리고 수익이 생긴 등급은 반드시 유통된다. 유통되는 등급은 관리되고, 관리되는 등급은 더 이상 조직의 상태가 아니다. 도입부에서 적은 다섯 가지 실패가 이 경로를 따라 하나씩 돌아온다.
...
**하나.** 이 진단 결과를 부서 간 비교에 쓰지 않는다. 취합하는 순간 순위표가 되고, 순위표가 생기면 그날부터 모든 답이 후해진다. 조직 전체를 보고 싶다면 단계 숫자를 모으지 말고 **병목 축과 갈린 문항을 모으자.** 그쪽이 예산 대화로 이어진다. 취합을 시키지 않아도 마찬가지다. 회의에서 누군가 자기 팀 단계를 입에 올리기 시작하면 그날부터 나머지 팀의 숫자는 조용히 올라간다.
...
**넷.** 대신 재주지 말자. 팀장이 서른 문항을 직접 읽는 그 15분이 결과지 여섯 줄보다 값지다. 조직에 남는 건 리포트가 아니라 잴 줄 아는 사람이다. 대행에는 값도 붙는데, 값이 붙는 순간 여력 없는 조직부터 이 자에서 떨어져 나간다.
...
10년 전 판돈은 등급이었다. 잘못 재면 등급을 못 따고, 못 따면 겸연쩍은 몇 달을 보내면 그만이었다. 지금 걸려 있는 건 그것보다 크다. AI를 어디에 얼마나 쓸지, 사람이 무엇을 하고 기계가 무엇을 할지, 그 판단을 무엇을 근거로 내릴지가 이 자의 눈금 위에서 정해진다. 잘못 잰 자리를 믿고 몇 년을 움직이면 되돌리는 데 다시 몇 년이 든다. 그래서 자를 쓰지 않는 것이 잘못 쓰는 것보다 낫다고 말한 것이다.
