...
바로 그 손길이 20년 전에도 있었다. 그렇다면 이번에는 무엇을 다르게 해야 할까? 답은 멀리 있지 않다. 망한 방식을 하나씩 거꾸로 뒤집으면 된다. 그래서 이 모델은 다섯 개의 실패에 하나씩 답을 붙여 설계했다.
...
등급을 남에게 증명해야 하는 순간 게임이 시작된다는 걸, 나는 20년 동안 그 판 안에서 지켜봤다. 그러니 이 자(尺)는 누구에게 보여주기 위한 물건이 아니다. 나와 내 조직이 지금 어디에 서 있는지를 스스로 확인하고, 다음 한 걸음을 고르기 위한 물건이다.
